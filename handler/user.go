...
func NewUserHandler(userService user.Service, authServive auth.Service) *userHandler {
	return &userHandler{userService, authServive}
}
...
func (h *userHandler) UploadAvatar(c *gin.Context) {
	...
	path := fmt.Sprintf("images/avatar/%d-avatar-%s", userID, file.Filename)
...
func (h *userHandler) FetchUser(c *gin.Context){
	currentUser := c.MustGet("currentUser").(user.User)
	formatter := user.FormatterUser(currentUser,"")
